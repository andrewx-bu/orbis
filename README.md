...
The current native demo renders a directionally lit, perspective-projected, depth-tested cube sphere with deterministic, seed-based terrain generated from six independent face grids.
